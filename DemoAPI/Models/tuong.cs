    ...
    public class tuong : MoveModel
    {
        ...
        public MoveModel checkMove(MoveModel node, MoveModel[,] board)
        {
            ...
            if (isWithin(node.top) != -1 && isWithin(node.left) != -1)
            {
                ...
                if ((curnode.curtop - isWithin(node.top)) / 75 == 1 && curnode.curleft == isWithin(node.left) &&
                    curnode.curtop >= -75)
                {
                ...
                if (curnode.curtop == isWithin(node.top) && (curnode.curleft - isWithin(node.left)) / 75 == 1
                        && curnode.curleft > -75)
                {
